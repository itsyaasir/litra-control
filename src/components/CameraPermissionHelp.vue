  ...
  <div class="fixed inset-0 bg-background/50 backdrop-blur-sm flex items-center justify-center z-50">
    <div class="bg-card/90 backdrop-blur-sm rounded-lg border border-border/50 shadow-lg p-6 max-w-md mx-4">
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          <h3 class="text-lg font-semibold text-foreground mb-2">Camera Permission Required</h3>
          ...
          <div class="space-y-4">
            <div>
              <h4 class="text-sm font-medium text-foreground mb-2">How to enable camera access:</h4>
              <div class="space-y-2">
                <div class="bg-muted/30 rounded-lg p-3">
                  <p class="text-xs font-medium text-foreground">macOS:</p>
                  <p class="text-xs text-muted-foreground">System Preferences → Security & Privacy → Camera → Enable for "Litra Control"</p>
                </div>
                <div class="bg-muted/30 rounded-lg p-3">
                  <p class="text-xs font-medium text-foreground">Windows:</p>
                  <p class="text-xs text-muted-foreground">Settings → Privacy → Camera → Allow desktop apps to access camera</p>
                </div>
                <div class="bg-muted/30 rounded-lg p-3">
                  <p class="text-xs font-medium text-foreground">Linux:</p>
                  <p class="text-xs text-muted-foreground">Camera access is usually granted by default, or check system settings</p>
                </div>
              </div>
            </div>
